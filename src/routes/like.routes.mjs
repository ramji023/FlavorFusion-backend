...
import { toggleRecipeLike, toggleCommentLike, getLikedRecipeByLoggedinUser } from "../controller/like.controller.mjs";
...
router.route("/liked-recipe").get(getLikedRecipeByLoggedinUser);
